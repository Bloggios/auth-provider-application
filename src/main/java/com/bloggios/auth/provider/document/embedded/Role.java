...
package com.bloggios.auth.provider.document.embedded;
...
public class Role {
    ...
    @Id
    @Field(name = "roleId", type = FieldType.Keyword, normalizer = ServiceConstants.DEFAULT_NORMALIZER)
    ...
    @Field(name = "version", type = FieldType.Keyword, normalizer = ServiceConstants.DEFAULT_NORMALIZER)
