...
import com.bloggios.auth.provider.properties.FetchErrorProperties;
...
import static com.bloggios.auth.provider.constants.ExceptionCodes.INTERNAL_ERROR;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ExceptionResponse> handleJsonMappingException(JsonMappingException exception) {
        ExceptionResponse build = ExceptionResponse
                .builder()
                .message(exception.getMessage())
                .code(ExceptionCodes.JSON_DESERIALIZATION)
    ...
    public ResponseEntity<ExceptionResponse> accessDeniedException(AccessDeniedException exception) {
        ExceptionResponse build = ExceptionResponse
                ...
                .type(ServiceConstants.DATA_ERROR_TYPE)
                .build();
        logger.error("""
