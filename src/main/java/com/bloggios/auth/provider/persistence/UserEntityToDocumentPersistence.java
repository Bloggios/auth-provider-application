...
@Component
public class UserEntityToDocumentPersistence {

    private final ModelMapper modelMapper;
    private final UserDocumentDao userDocumentDao;

    public UserEntityToDocumentPersistence(
    ...
    public void persist(UserEntity userEntity, DaoStatus daoStatus) {
        UserDocument userDocument = modelMapper.map(userEntity, UserDocument.class);
        userDocumentDao.initOperation(daoStatus, userDocument);
    }
}
