...
package com.bloggios.auth.provider.processor.elasticprocessor;
...
@Component
public class EsUserAuthPersistProcessor {

    private final UserDocumentDao userDocumentDao;
    private final ModelMapper modelMapper;

    public EsUserAuthPersistProcessor(
    ...
    public UserDocument persistData(UserEntity userEntity) {
        UserDocument userAuth = modelMapper.map(userEntity, UserDocument.class);
        return userDocumentDao.createUser(userAuth);
    }
}
