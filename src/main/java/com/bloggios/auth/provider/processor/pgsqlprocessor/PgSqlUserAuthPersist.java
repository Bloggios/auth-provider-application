...
package com.bloggios.auth.provider.processor.pgsqlprocessor;
...
@Component
public class PgSqlUserAuthPersist implements Process<UserDocument> {

    private final ModelMapper modelMapper;
    private final UserEntityDao userEntityDao;

    public PgSqlUserAuthPersist(ModelMapper modelMapper, UserEntityDao userEntityDao) {
