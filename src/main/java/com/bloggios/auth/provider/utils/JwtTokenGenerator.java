...
public class JwtTokenGenerator {
    ...
    public String generateAccessToken(Authentication authentication, String origin, Boolean isLong, String remoteAddress) {
        ...
        JwtClaimsSet jwtClaimSet = JwtClaimsSet.builder()
                ...
                .claim(ServiceConstants.USERNAME, principal.getBloggiosUsername())
    ...
    public String generateCookieToken(Authentication authentication, String origin, String remoteAddress) {
        UserPrincipal principal = (UserPrincipal) authentication.getPrincipal();
        List<String> roles = authentication.getAuthorities().stream()
                .map(GrantedAuthority::getAuthority)
                .toList();
