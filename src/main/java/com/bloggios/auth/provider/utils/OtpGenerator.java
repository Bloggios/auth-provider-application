...
import static com.bloggios.auth.provider.constants.ServiceConstants.MINUTES_7;
...
public class OtpGenerator {
    ...
    public ForgetPasswordDocument forgetPasswordOtpSupplier(UserEntity userEntity) {
