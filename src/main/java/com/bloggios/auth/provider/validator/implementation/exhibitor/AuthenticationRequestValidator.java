...
public class AuthenticationRequestValidator implements Exhibitor<AuthenticationRequest> {
    ...
    private final AuthenticationRequestUsernamePasswordValidator authenticationRequestUsernamePasswordValidator;

    public AuthenticationRequestValidator(
            AuthenticationRequestUsernamePasswordValidator authenticationRequestUsernamePasswordValidator
    ) {
        this.authenticationRequestUsernamePasswordValidator = authenticationRequestUsernamePasswordValidator;
    }

    @Override
    public void validate(AuthenticationRequest authenticationRequest) {
        authenticationRequestUsernamePasswordValidator.validate(authenticationRequest);
    }
}
