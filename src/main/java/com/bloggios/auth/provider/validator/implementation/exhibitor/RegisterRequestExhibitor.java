...
import com.bloggios.auth.provider.validator.implementation.businessvalidator.EmailValidationProvider;
...
@Component
public class RegisterRequestExhibitor {
    ...
    public void validate(RegisterRequest request) {
            emailValidationProvider.validate(request.getEmail());
